...
export default function Card() {
  return (
    <div className="p-[2rem] bg-[#1f1f1f] rounded-[0.7rem]">
      <div className="inside  flex flex-col justigy-center items-center w-[20rem] h-[35rem] ">
        <img src={pic} alt="pic" className="w-[6rem] h-[6rem] rounded-full mb-[1rem]" />
        <p className="text-[#ffffff] text-[1.8rem] font-semibold">Jessica Randall</p>
        <p className="text-[#c5f82a] font-semibold mb-[1.5rem]">London, United Kingdom</p>
        <p className="text-[#ffffff] font-semibold mb-[1rem]">"Front-end developer and avid reader."</p>
